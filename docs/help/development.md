...
## Quick Start
``` sh
    git clone https://github.com/daspanel/mailhog-mail-catcher
...
1. Run a container using this image and getting an interactive shell:
    <!-- language: lang-sh -->
        ...
        docker-compose run mailhog-mail-catcher /bin/sh
...
2. Execute scripts inside a running container:
    ...
    2. Excute the script:
        <!-- language: lang-sh -->
            ...
            docker-compose exec mailhog-mail-catcher /app/yourscript
